    ...
    def search_btn_click_event(self):
        ...
        if searched_type == 'CAS':
            try:
                ...
                QMessageBox.about(self, "No results found.",
                                  "We do not have any datas for \"{}\"".format(searched_input))
                return
        ...
        try:
            ...
            QMessageBox.about(self, "Error",
                              "There is no database corresponding to the {} in the mass spectrum DB".format(smiles))
            return
