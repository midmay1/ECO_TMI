...
from PyQt5.QtWidgets import (QWidget, QDesktopWidget, QGroupBox, QGridLayout, QVBoxLayout, QHBoxLayout,
                             QLineEdit, QTextEdit, QRadioButton, QPushButton, QLabel,QBoxLayout,
                             QTableWidget, QTableWidgetItem, QCheckBox, QComboBox, QMessageBox,
                             QFileDialog, QPushButton,QLineEdit,QApplication)
...
class MyApp(QWidget):
    ...
    def _create_mass_grid(self):
      ...
      #  self.msinfo_fig=plt.figure()
        ...
        # +Added) Add msinfo grid
        self.msinfo_fig = plt.Figure()
        self.msinfo_canvas=FigureCanvas(self.msinfo_fig)
        
        self.msinfo_fig.clear()
        ax=self.msinfo_fig.add_subplot(111)
        plt.tight_layout()
        self.msinfo_canvas.draw()
        ...
        self.msinfo_grid = self._create_mass_metadata_grid()
        save_print_layout.addWidget(self.msinfo_grid)
